...
)
{
    ...
    else
    {
        ...
        pvvRoot["gRayGeometryVolume"] = mpGVVolume;
        pvvRoot["gRayPVVVolume"] = mpPVVVolume;
        pvvRoot["PVVRayCB"]["gRaySceneMin"] = volumeMin;
        pvvRoot["PVVRayCB"]["gRaySceneExtent"] = volumeExtent;
        pvvRoot["PVVRayCB"]["gRayVolumeSize"] = mVolumeSize;
        pvvRoot["PVVRayCB"]["gRayVolumeDepth"] = mVolumeDepth;
        pvvRoot["PVVRayCB"]["gRayViewCellCenter"] = viewCellCenter;
        pvvRoot["PVVRayCB"]["gRayViewCellRadius"] = viewCellRadius;
        pvvRoot["PVVRayCB"]["gRaySampleCount"] = 9u;
        pvvRoot["PVVRayCB"]["gRayUseCameraFrustum"] = 0u;
        pvvRoot["PVVRayCB"]["gRayCameraFovYRadians"] = sampleCameraFovYRadians;
        pvvRoot["PVVRayCB"]["gRayCameraAspectRatio"] = mCameraAspectRatio;
        pvvRoot["PVVRayCB"]["gRayCameraForward"] = volumeProjection.forward;
        pvvRoot["PVVRayCB"]["gRayUseProjectionVolume"] = useProjectionVolume ? 1u : 0u;
        pvvRoot["PVVRayCB"]["gRayViewCellNearPlane"] = volumeProjection.nearPlane;
        pvvRoot["PVVRayCB"]["gRayViewCellFarPlane"] = volumeProjection.farPlane;
        pvvRoot["PVVRayCB"]["gRayTanHalfFovX"] = volumeProjection.tanHalfFovX;
        pvvRoot["PVVRayCB"]["gRayTanHalfFovY"] = volumeProjection.tanHalfFovY;
        pvvRoot["PVVRayCB"]["gRayViewCellPosition"] = volumeProjection.viewCellPosition;
